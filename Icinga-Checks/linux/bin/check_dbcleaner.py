...
Description:
    ...
    Also checks LongText Column to ensure false-positives are ignored due to partions getting dropped (i.e. can't drop the only partition in a table)
...
def Check_DBCleaner(db_user, db_pass, db_inst):
    ...
    query = """
        ...
        and longtext not like '%cannot drop the only partition%'
